...
typedef struct 
{
  ...
  uint8_t  reserved4                     : 1;
  uint8_t  reserved5                     : 1;
  uint8_t  is_motor_voltage_check_finish : 1;
  uint8_t  is_motor_voltage_check        : 1;
  
  uint8_t  is_enable_gps_check_finish    : 1;
  uint8_t  is_close_sw_check_finish          : 1;
  uint8_t  is_close_sw_check             : 1;
  uint8_t  is_open_sw_check_finish       : 1;
  uint8_t  is_open_sw_check              : 1;
  ...
  uint8_t  is_communicate_with_hl300     : 1;
  uint8_t  is_uart_sw_to_hl300           : 1;
